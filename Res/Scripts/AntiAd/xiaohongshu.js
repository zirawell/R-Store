...
try {
  ...
  if (typeof obj !== "object" || obj === null) throw new Error("Invalid response schema");
} catch (e) {
  $done({body: rsp_body});
}
// 信息流 图片
