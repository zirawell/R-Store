/********************************
Amap Remove Ads - Version 1.0
Checkout Source - https://raw.githubusercontent.com/RuCu6/QuanX/main/Scripts/amap.js
...
} else if (url.includes("/shield/dsp/profile/index/nodefaasv")) {
  // 我的页面
  if (obj?.data?.cardList?.length > 0) {
